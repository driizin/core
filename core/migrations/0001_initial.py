    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cor_pele', models.CharField(blank=True, max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professores', models.ManyToManyField(limit_choices_to={'tipo': 'professor'}, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nota_1_semestre', models.FloatField(default=0)),
                ('nota_2_semestre', models.FloatField(default=0)),
                ...
                ('status_final', models.CharField(blank=True, max_length=15)),
